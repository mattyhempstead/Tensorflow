...
def getModel():
    ...
    model.add(keras.layers.Conv2D(32, (3, 3), activation=act, input_shape=(32, 32, 3)))
    # model.add(keras.layers.Dropout(0.05))

    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.Conv2D(32, (3, 3), activation=act))
    model.add(keras.layers.MaxPooling2D((2, 2)))
    model.add(keras.layers.Dropout(0.3))

    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.Conv2D(64, (3, 3), activation=act))
    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.Conv2D(64, (3, 3), activation=act))
    model.add(keras.layers.MaxPooling2D((2, 2)))
    model.add(keras.layers.Dropout(0.3))
    ...
    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.Conv2D(128, (3, 3), activation=act))
    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.Conv2D(128, (3, 3), activation=act))
    # model.add(keras.layers.MaxPooling2D((2, 2)))
    model.add(keras.layers.Dropout(0.3))
    ...
    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.Dense(256, activation=act))
    model.add(keras.layers.Dropout(0.3))

    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.Dense(128, activation=act))
    model.add(keras.layers.Dropout(0.3))
